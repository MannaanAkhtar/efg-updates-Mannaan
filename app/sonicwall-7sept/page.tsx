...
// ─── Data ────────────────────────────────────────────────────────────────────
const TAKEAWAYS = [
  { heading: "Strategic Direction.", desc: "A clear view of SonicWall's strategic direction for the next five years and how it aligns with evolving cybersecurity priorities." },
  { heading: "Modern Perimeter.", desc: "Practical insight into centralized cloud-managed perimeter security, Cloud Secure Edge, ZTNA, and SASE as foundations for modern protection." },
  { heading: "Managed Security.", desc: "A better understanding of how managed security services, SOC, MDR, and MXDR can strengthen resilience, reduce risk, and improve security outcomes." },
];

const PAIN_POINTS = [
  { title: "The Challenge", desc: "Organizations are facing expanding attack surfaces, fragmented security tools, and growing pressure to protect users, applications, and data across increasingly hybrid environments. This roundtable helps decision-makers cut through complexity by focusing on practical security approaches that improve visibility, simplify management, and deliver measurable outcomes." },
  { title: "Why Attend", desc: "Attendees should join to gain strategic insight, practical guidance, and peer-level perspectives on how to modernize security beyond the firewall. The session is designed to help leaders identify what works, where to prioritize investment, and how to strengthen protection with cloud-delivered and managed security models." },
];
...
const AGENDA = [
  { time: "10:00 AM", duration: "", title: "Registration", presenter: "" },
  { time: "10:30 AM", duration: "30 min", title: "SonicWall Strategic Outlook — The Next 5 Years", presenter: "", highlight: true },
  { time: "11:00 AM", duration: "45 min", title: "Centralized Cloud-Managed Perimeter Security", presenter: "", highlight: true },
  { time: "11:45 AM", duration: "15 min", title: "Coffee Break", presenter: "" },
  { time: "12:00 PM", duration: "45 min", title: "Cloud Secure Edge, ZTNA and SASE", presenter: "", highlight: true },
  { time: "12:45 PM", duration: "45 min", title: "Managed Security Services (SOC / MDR / MXDR … & More)", presenter: "", highlight: true },
  { time: "1:30 PM", duration: "30 min", title: "Case Study + Q&A", presenter: "" },
  { time: "2:00 PM", duration: "", title: "Lunch", presenter: "" },
];
  ...
  return (
    <section ref={heroRef} style={{ position: "relative", overflow: "hidden", minHeight: "100vh" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "120px clamp(24px, 5vw, 80px) 100px", width: "100%" }}>
          <div style={{ maxWidth: 580 }}>
            ...
            <div className="sw-kicker" style={{
              ...
              <span style={{ fontFamily: "var(--font-outfit)", fontSize: 12, fontWeight: 400, letterSpacing: "2.5px", textTransform: "uppercase", color: SW_ORANGE }}>Executive Roundtable</span>
            </div>
      ...
      <div className="sw-countdown-wrap" style={{ position: "absolute", bottom: 28, left: 0, right: 0, zIndex: 2, display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        <CountdownDisplay target="2026-09-07T10:00:00+03:00" />
      </div>
...
// ─── OVERVIEW ────────────────────────────────────────────────────────────────
const OVERVIEW_WORDS = "What comes next, beyond the firewall.".split(" ");
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "0 clamp(20px, 4vw, 60px)", position: "relative", zIndex: 2 }}>
        ...
        <div ref={headerRef} style={{ textAlign: "center", marginBottom: 24 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14, justifyContent: "center" }}>
            ...
            <span className="sw-ov-kicker" style={{ fontFamily: "var(--font-outfit)", fontSize: 12, fontWeight: 400, letterSpacing: "2.5px", textTransform: "uppercase", color: SW_ORANGE, opacity: 0 }}>About This Roundtable</span>
            <div className="sw-ov-dash" style={{ width: 28, height: 2, background: SW_ORANGE, borderRadius: 1, transform: "scaleX(0)" }} />
          </div>
        ...
        <div ref={bodyRef} style={{ maxWidth: 780, margin: "0 auto", textAlign: "center" }}>
          <p className="sw-ov-para" style={{ fontFamily: "var(--font-outfit)", fontSize: 15.5, fontWeight: 400, color: "#333", lineHeight: 1.8, margin: "0 0 12px", opacity: 0, clipPath: "inset(0 0 30% 0)" }}>
            This executive roundtable brings together cybersecurity leaders for a focused discussion on what comes next beyond traditional firewall protection. The session will explore SonicWall&apos;s strategic outlook, modern cloud-managed perimeter security, and the role of Cloud Secure Edge, ZTNA, and SASE in strengthening today&apos;s distributed environments.
          </p>
          <p className="sw-ov-para" style={{ fontFamily: "var(--font-outfit)", fontSize: 15.5, fontWeight: 400, color: "#333", lineHeight: 1.8, margin: "0 0 28px", opacity: 0, clipPath: "inset(0 0 30% 0)" }}>
            Attendees will also examine how managed security services, including SOC, MDR, and MXDR, can help organizations reduce risk, improve resilience, and achieve better security outcomes.
          </p>

          {/* Case study callout — liquid glass skeuomorphic */}
          <div className="sw-ov-callout" style={{ display: "inline-flex", alignItems: "center", gap: 12, padding: "14px 28px", borderRadius: 50, background: "linear-gradient(145deg, rgba(160,190,240,0.3) 0%, rgba(200,220,250,0.25) 50%, rgba(255,230,215,0.2) 100%)", border: "1px solid rgba(255,255,255,0.5)", boxShadow: "inset 0 1px 0 rgba(255,255,255,0.8), inset 0 -1px 0 rgba(0,0,0,0.04), 0 6px 24px rgba(0,0,0,0.07), 0 1px 4px rgba(0,0,0,0.04)", opacity: 0 }}>
            ...
            <span style={{ fontFamily: "var(--font-outfit)", fontSize: 13.5, fontWeight: 500, color: SW_DARK, letterSpacing: "0.1px" }}>Concludes with a practical case study and Q&amp;A</span>
          </div>
        </div>
      </div>
    ...
    <section ref={ref} style={{ background: SW_CREAM, padding: "clamp(44px, 5vw, 64px) 0" }}>
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "0 clamp(20px, 4vw, 60px)" }}>
        ...
        <div style={{ marginBottom: 32 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
            <div style={{ width: 28, height: 2, background: SW_ORANGE, borderRadius: 1 }} />
            <span style={{ fontFamily: "var(--font-outfit)", fontSize: 12, fontWeight: 400, letterSpacing: "2.5px", textTransform: "uppercase", color: SW_ORANGE }}>Context</span>
          </div>
        ...
        {/* Cards */}
        <div ref={cardsRef} style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 16 }} className="sw-pain-grid">
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "0 clamp(20px, 4vw, 60px)" }}>
        ...
        <div ref={headerRef} style={{ marginBottom: 32 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
            ...
            <span className="sw-spk-kicker" style={{ fontFamily: "var(--font-outfit)", fontSize: 12, fontWeight: 400, letterSpacing: "2.5px", textTransform: "uppercase", color: SW_ORANGE, opacity: 0 }}>Your Moderator</span>
          </div>
        ...
        {/* Cards */}
        <div ref={cardsRef} style={{ display: "grid", gridTemplateColumns: "minmax(280px, 360px)", justifyContent: "center", gap: 20 }} className="sw-speakers-grid">
          ...
          {AGENDA.map((item, i) => (
            <div key={item.title} className="sw-agenda-row" style={{ display: "flex", gap: 20, padding: "18px 16px", margin: "0 -16px", alignItems: "flex-start", opacity: 0, position: "relative" }}>
              ...
              <div style={{ flexShrink: 0, width: 76, textAlign: "right", paddingTop: 1 }}>
                ...
                {item.duration && <span style={{ fontFamily: "var(--font-outfit)", fontSize: 10.5, fontWeight: 400, color: "#aaa", display: "block", marginTop: 2, letterSpacing: "0.3px" }}>{item.duration}</span>}
              </div>
              ...
              <div style={{ flex: 1 }}>
                ...
                {item.presenter && <p style={{ fontFamily: "var(--font-outfit)", fontSize: 13, fontWeight: 400, color: "#888", margin: 0, lineHeight: 1.5 }}>{item.presenter}</p>}
              </div>
            </div>
          ))}
        </div>
...
function RegistrationSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await submitForm({
      ...
      phone: combinedPhone,
      event_name: "Cyber Resilience in the Age of Real-Time Threats — SonicWall Roundtable · 7 September 2026",
      metadata: {
        message: formData.message || "",
        event_date: "7 September 2026",
        event_time: "10:00 AM KSA",
        event_duration: "180 minutes",
        event_format: "Presentation followed by lunch",
      },
    });
    setSubmitting(false);
        ...
        <div className="sw-reg-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.15fr", gap: "clamp(28px, 4vw, 48px)", alignItems: "center" }}>
          ...
          <div ref={headerRef} style={{ paddingTop: 8 }}>
            ...
            <p className="sw-reg-desc" style={{ fontFamily: "var(--font-outfit)", fontSize: 16, fontWeight: 400, color: "#222", lineHeight: 1.75, margin: 0, maxWidth: 380, opacity: 0 }}>
              This is an exclusive, invite-only executive roundtable for senior cybersecurity leaders. Submit your details and our team will confirm your place within 24 hours.
            </p>
            ...
            <div style={{ marginTop: 28, display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                ...
                "180-minute programme with lunch",
                "Chatham House Rule",
              ].map(t => (
