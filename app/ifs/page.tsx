        ...
        <div id="overview" className="ifs-hero-grid" style={{
          ...
          <div>
            ...
            <motion.div
              ...
              style={{ marginTop: 22 }}
            >
              <CountdownTimer targetIso="2026-06-23T10:00:00+03:00" />
            </motion.div>
          </div>
...
function AgendaAndFormSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const res = await submitForm({
      ...
      phone: fullPhone,
      event_name: "IFS Executive Briefing — Responding to Supply Chain Disruption · Riyadh 23 June 2026",
      metadata: {
        "Event Page": "IFS Executive Briefing · Riyadh",
      ...
      <div style={{
        ...
        {SPEAKERS.map((sp, i) => (
          ...
          >
            ...
            <div className="ifs-about-grid" style={{
              display: "grid",
              ...
              <div style={{ display: "flex", justifyContent: "center" }}>
                <SpeakerAvatar photo={sp.photo} initials={sp.initials} size={200} />
              </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Executive Briefing · IFS · Riyadh, 23 June 2026
          </p>
        </div>
      </div>
