...
const UPCOMING_EVENTS = [
  ...
  },
  {
    ...
    image: "",
    brandColor: "#0070C1",
    brandGradient: "linear-gradient(135deg, #0070C1 0%, #00528b 40%, #0B1B3A 75%, #0a0a0a 100%)",
    brandLogo: "https://efg-final.s3.eu-north-1.amazonaws.com/sponsors-logo/AlgoSecLOGO-eps.png",
  },
  {
    ...
    day: "14",
    year: "2026",
    time: "10:00 – 14:00 AST",
    title: "Oracle AI: Powering the Intelligent Enterprise",
    subtitle: "An exclusive executive experience",
    sponsor: "Oracle",
    location: "Riyadh, Saudi Arabia",
    link: "/oracle",
    image: "",
    brandColor: "#C74634",
    brandGradient: "linear-gradient(135deg, #C74634 0%, #8E3226 40%, #3A1C17 75%, #0a0a0a 100%)",
    brandLogo: "https://efg-final.s3.eu-north-1.amazonaws.com/sponsors-logo/oracle-seeklogo.png",
  },
  {
    ...
    day: "21",
    year: "2026",
    time: "10:00 – 12:30 GST",
    title: "IFS Executive Briefing",
    subtitle: "Responding to Supply Chain Disruption — In Weeks, Not Months",
    sponsor: "IFS",
    location: "Dubai, UAE",
    link: "/ifs-dubai",
    image: "",
  ...
  },
  {
    ...
    subtitle: "An executive lunch for BFSI leaders, Dubai",
    sponsor: "UnifyApps",
    location: "Dubai, UAE",
    link: "https://engage.unifyapps.com/rsvp/signature-lunch-dubai-october-2026?utm_medium=agcy&utm_source=email&utm_content=ev&utm_campaign=20261013_MEA_OWNED_Lunch_SE_BFSI_Dubai",
    image: "",
    brandColor: "#6E86FF",
    brandGradient: "linear-gradient(140deg, #FBFCFF 0%, #EEF1FF 40%, #DCE3FF 72%, #C6D2FF 100%)",
    brandLogo: "https://efg-final.s3.eu-north-1.amazonaws.com/sponsors-logo/unifyapps+logo.svg",
    darkLogo: true,
  },
  {
    ...
    time: "10:00 AM – 1:30 PM",
    title: "UnifyApps Signature Lunch",
    subtitle: "An executive lunch for Healthcare & Telecom leaders, Dubai",
    sponsor: "UnifyApps",
    location: "Dubai, UAE",
    link: "https://engage.unifyapps.com/rsvp/se-healthcare-telecom-lunch-dubai-october-2026?utm_medium=agcy&utm_source=email&utm_content=ev&utm_campaign=20261015_MEA_OWNED_Lunch_SE_Healthcare_Telecom_Dubai",
    image: "",
    brandColor: "#6E86FF",
    brandGradient: "linear-gradient(140deg, #FBFCFF 0%, #EEF1FF 40%, #DCE3FF 72%, #C6D2FF 100%)",
    brandLogo: "https://efg-final.s3.eu-north-1.amazonaws.com/sponsors-logo/unifyapps+logo.svg",
...
const PAST_EVENTS_2026: PastEvent[] = [
  ...
  },
  {
    ...
    subtitle: "From Digital Investment to Measurable Execution — 100 Senior Executives",
    month: "MAY",
    date: "21 May",
    venue: "Virtual",
    time: "11:00 AM GST",
    ...
    link: "/events/opex-first/process-intelligence",
  },
  {
    sponsor: "OutSystems",
    title: "OutSystems Agentic Lab Workshop",
    subtitle: "Hands-on workshop on building agentic enterprise applications",
    month: "MAY",
    date: "20 May",
    venue: "Virtual",
    time: "1:00 PM – 2:30 PM GST",
    image: "",
    brandColor: "#E62B2C",
    brandLogo: "https://efg-final.s3.eu-north-1.amazonaws.com/logos/outsystems.png",
    link: "https://www.outsystems.com/webinars/agentic-lab-workshop/?utm_source=efg&utm_medium=referral&utm_campaign=emea-mea-wb-2026-05-20-agentic-lab-workshop&utm_term=none&utm_content=none&utm_campaignteam=camp-emea&utm_partner=none",
  },
  {
                          ...
                          {e.image ? (
                            ...
                            <div style={{
                              ...
                              background: (e as Record<string, unknown>).lightCard === true
                                ...
                                : (e as unknown as Record<string, string>).brandGradient
                              ...
                              {(e as unknown as Record<string, string>).brandLogo && (
                                (e as unknown as Record<string, string>).brandLogoTop ? (
                                  ...
                                  // eslint-disable-next-line @next/next/no-img-element
                                  <img src={(e as unknown as Record<string, string>).brandLogo} alt="" style={{
                                    height: e.sponsor === "Crayon" || e.sponsor === "Crayon × Microsoft" ? 200 : e.sponsor === "Poka" ? 140 : e.sponsor === "Braze x Talon.One" ? 80 : e.sponsor === "Braze" ? 50 : e.sponsor === "UnifyApps" ? 64 : 72,
                                    width: "auto",
                                    opacity: 0.9,
                                    filter: (e as unknown as Record<string, unknown>).darkLogo === true ? "brightness(0) opacity(0.82) drop-shadow(0 1px 3px rgba(0,0,0,0.12))" : "brightness(0) invert(1) drop-shadow(0 2px 8px rgba(0,0,0,0.35))"
                                  }} />
                                )
                              )}
