...
export const metadata: Metadata = {
  ...
  description:
    "A closed-door AlgoSec executive roundtable securing application connectivity across the hybrid enterprise. 13 October 2026, Dubai. A gamified AlgoCity challenge, senior peer discussion, and networking reception.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Securing application connectivity across the hybrid enterprise. A closed-door executive roundtable, Dubai · 13 October 2026.",
    url: PAGE_URL,
  ...
  twitter: {
    ...
    site: "@eventsfirstgrp",
    title: "AlgoCity: Escape the Complexity — AlgoSec Executive Roundtable",
    description: "Securing application connectivity across the hybrid enterprise. Dubai · 13 October 2026.",
    images: [OG_IMAGE],
  },
};
