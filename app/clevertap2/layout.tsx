...
export const metadata: Metadata = {
  ...
  description:
    "A 90-minute virtual roundtable for marketing and CRM leaders. Relevance builds trust. Trust builds revenue. May 13, 2026.",
  keywords: [
    "CleverTap webinar",
    "customer engagement",
    "retention strategy",
  ...
  openGraph: {
    ...
    description: "Relevance builds trust. Trust builds revenue. May 13, 2026 — 90 min virtual roundtable.",
    url: PAGE_URL,
