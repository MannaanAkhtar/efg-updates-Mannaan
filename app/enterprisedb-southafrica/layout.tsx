...
const PAGE_URL = `${BASE_URL}/enterprisedb-southafrica`;
const OG_IMAGE = "https://efg-final.s3.eu-north-1.amazonaws.com/sponsors-logo/edb_postgres_ai_lightmode%402x+(4).png";

export const metadata: Metadata = {
  title: "The Sovereign Data Estate | EDB Executive Roundtable, South Africa — 12 Nov 2026",
  description:
    "An invite-only executive roundtable on building a sovereign data estate on open-source Postgres — reducing cost, meeting data-sovereignty mandates, and scaling with AI. 12 November 2026, South Africa. Hosted with EDB.",
  keywords: [
    ...
    "executive roundtable South Africa",
    "CIO CTO roundtable South Africa",
  ...
  openGraph: {
    title: "The Sovereign Data Estate — EDB Executive Roundtable, South Africa",
    description:
      "Breaking free from proprietary lock-in: a closed-door roundtable for senior IT & data leaders on building a sovereign data estate with Postgres. 12 November 2026.",
    url: PAGE_URL,
  ...
  twitter: {
    ...
    title: "The Sovereign Data Estate — EDB Executive Roundtable, South Africa",
    description:
      "A closed-door roundtable for senior IT & data leaders on building a sovereign data estate with Postgres. 12 November 2026, South Africa.",
    images: [OG_IMAGE],
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            startDate: "2026-11-12T09:00:00+02:00",
            endDate: "2026-11-12T12:00:00+02:00",
