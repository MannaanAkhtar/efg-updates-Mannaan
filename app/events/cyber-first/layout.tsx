  ...
  return (
    <>
      ...
      <SeriesFactBlock
        ...
        editions={[
          { name: "Cyber First Kuwait 2026 (3rd Annual)", city: "Kuwait City", country: "Kuwait", date: "17 November 2026", url: `${BASE_URL}/events/cyber-first/kuwait-2026` },
          ...
          { name: "Cyber First Qatar 2026", city: "Doha", country: "Qatar", date: "10 November 2026", url: `${BASE_URL}/events/cyber-first/qatar` },
        ]}
        url={PAGE_URL}
      />
      {children}
