...
const CFK_SPONSORS_2026: { name: string; logo: string; url: string; tier: "strategic" | "gold" | "panel" | "associate" | "networking" | "media" }[] = [
  ...
  { name: "CYFIRMA", logo: `${S3}/sponsors-logo/cyfirma_logo.png`, url: "https://www.cyfirma.com/", tier: "panel" },
  ...
  return (
    <div style={{ background: "#0A0608" }}>
      <style jsx global>{`
        ...
        /* Request Resources hero dropdown */
        .cfk-req-ghost:hover {
          transform: translateY(-2px);
          background: rgba(255,255,255,0.12) !important;
          border-color: rgba(255,255,255,0.3) !important;
          color: white !important;
          box-shadow: inset 0 1px 0 rgba(255,255,255,0.15), 0 8px 24px rgba(0,0,0,0.3) !important;
        }
        .cfk-req-menu-item:hover { background: ${C_BRIGHT}1a !important; }
        .cfk-req-menu-item:focus-visible { outline: none; background: ${C_BRIGHT}22 !important; }
    ...
    >
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 clamp(20px, 4vw, 60px)", position: "relative", zIndex: 2 }}>
        ...
        <motion.div
          ...
          style={{ textAlign: "center", marginBottom: "clamp(20px, 2.4vw, 32px)" }}
        >
        ...
        {/* Gold sponsor grid */}
        <div className="cfk-sponsors-grid cfk-sponsors-grid-gold" style={{
          display: "grid",
          gridTemplateColumns: `repeat(${Math.min(CFK_SPONSORS_2026.filter(s => s.tier === "gold").length, 3)}, minmax(200px, 280px))`,
          gap: 20,
          justifyContent: "center",
          marginBottom: "clamp(40px, 5vw, 64px)",
        }}>
          {CFK_SPONSORS_2026.filter(s => s.tier === "gold").map((sponsor, i) => (
            <motion.a
              key={sponsor.name}
              href={sponsor.url}
            ...
            >
              <div className="cfk-sponsor-glow" style={{
                ...
                inset: -24,
                borderRadius: 36,
                background: `radial-gradient(ellipse 75% 65% at 30% 30%, rgba(212,168,75,0.28) 0%, transparent 65%), radial-gradient(ellipse 60% 60% at 75% 80%, rgba(181,34,48,0.18) 0%, transparent 70%)`,
                filter: "blur(26px)",
                opacity: 0.6,
                pointerEvents: "none",
                transition: "opacity 0.55s ease",
              ...
              <div className="cfk-sponsor-bezel" style={{
                ...
                background: `
                  linear-gradient(135deg,
                    rgba(212,168,75,0.95) 0%,
                    rgba(255,235,200,0.55) 18%,
                    rgba(180,150,110,0.12) 42%,
                    rgba(120,80,40,0.06) 55%,
                    rgba(255,230,180,0.3) 72%,
                    rgba(212,168,75,0.55) 88%,
                    rgba(212,168,75,0.95) 100%
                  )
                `,
                boxShadow: `
                  0 30px 70px rgba(0,0,0,0.55),
                  0 12px 30px rgba(0,0,0,0.35),
                  0 0 50px rgba(212,168,75,0.22),
                ...
                <div style={{
                  ...
                  height: "32%",
                  background: "linear-gradient(180deg, rgba(255,235,200,0.35) 0%, rgba(255,235,200,0.05) 60%, transparent 100%)",
                ...
                <div style={{
                  ...
                  overflow: "hidden",
                  background: `
                    radial-gradient(ellipse 140% 80% at 50% -20%, rgba(212,168,75,0.18) 0%, transparent 55%),
                    radial-gradient(ellipse 120% 80% at 50% 120%, rgba(181,34,48,0.1) 0%, transparent 50%),
                    linear-gradient(165deg, rgba(28,18,10,0.98) 0%, rgba(20,12,8,0.99) 50%, rgba(12,8,5,1) 100%)
                  `,
                  padding: "0 10px",
                  minHeight: 180,
                  display: "flex",
                  ...
                  <div style={{
                    ...
                    top: 6, left: 10,
                    width: 36, height: 36,
                    background: "radial-gradient(circle at 30% 30%, rgba(255,240,220,0.55), transparent 60%)",
                    pointerEvents: "none",
                    zIndex: 3,
                    filter: "blur(2px)",
                  }} />
                  ...
                  <div style={{
                    ...
                    height: 1,
                    background: `linear-gradient(90deg, transparent 10%, rgba(255,235,200,0.14) 40%, rgba(212,168,75,0.22) 55%, rgba(255,235,200,0.1) 75%, transparent 95%)`,
                  ...
                  <div style={{
                    ...
                    height: 1,
                    background: `linear-gradient(90deg, transparent, rgba(212,168,75,0.7), transparent)`,
                    boxShadow: `0 0 18px rgba(212,168,75,0.55)`,
                    pointerEvents: "none",
                    zIndex: 2,
                  }} />
                  ...
                  <div style={{
                    ...
                    top: 0, left: "8%", right: "8%",
                    height: 1,
                    background: `linear-gradient(90deg, transparent, ${KENYA_GOLD}ee, transparent)`,
                    boxShadow: `0 0 18px ${KENYA_GOLD}a0`,
                    pointerEvents: "none",
                    zIndex: 3,
                  }} />
                  ...
                  <div className="cfk-sponsor-shine" style={{
                    ...
                    width: "55%",
                    height: "100%",
                    background: "linear-gradient(100deg, transparent, rgba(255,235,200,0.22) 50%, transparent)",
                    transform: "skewX(-20deg)",
                    pointerEvents: "none",
                    transition: "left 1s cubic-bezier(0.22, 1, 0.36, 1)",
                    zIndex: 4,
                  ...
                  <img
                    ...
                    style={{
                      ...
                      height: "auto",
                      objectFit: "contain",
                      filter: "brightness(1.1) drop-shadow(0 3px 10px rgba(0,0,0,0.65)) drop-shadow(0 1px 2px rgba(212,168,75,0.3))",
        ...
        {/* ── Associate Sponsor sub-heading ── */}
        <motion.div
          initial={{ opacity: 0, y: 14 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.8, delay: 0.5, ease: [0.22, 1, 0.36, 1] }}
          style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 16, marginBottom: "clamp(20px, 2.4vw, 32px)", marginTop: "clamp(40px, 5vw, 64px)" }}
        >
          <div style={{ flex: "0 1 90px", height: 1, background: `linear-gradient(to right, transparent, ${KENYA_GOLD}55)` }} />
          <span style={{
            fontFamily: "var(--font-dm-sans)",
        ...
        {/* Associate sponsor grid */}
        <div className="cfk-sponsors-grid cfk-sponsors-grid-associate" style={{
          display: "grid",
          gridTemplateColumns: `repeat(${Math.min(CFK_SPONSORS_2026.filter(s => s.tier === "associate").length, 3)}, minmax(200px, 280px))`,
          gap: 20,
          justifyContent: "center",
        }}>
          {CFK_SPONSORS_2026.filter(s => s.tier === "associate").map((sponsor, i) => (
            <motion.a
              key={sponsor.name}
              href={sponsor.url}
              target={sponsor.url && sponsor.url !== "#" ? "_blank" : undefined}
              rel={sponsor.url && sponsor.url !== "#" ? "noopener noreferrer" : undefined}
              aria-label={`${sponsor.name} — associate sponsor`}
              initial={{ opacity: 0, y: 36, scale: 0.96, filter: "blur(6px)" }}
              animate={inView ? { opacity: 1, y: 0, scale: 1, filter: "blur(0px)" } : {}}
        ...
        {/* ── Networking Partner sub-heading ── */}
        <motion.div
          initial={{ opacity: 0, y: 14 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
        ...
        {/* Networking partner grid */}
        <div className="cfk-sponsors-grid cfk-sponsors-grid-networking" style={{
          display: "grid",
          gridTemplateColumns: `repeat(${Math.min(CFK_SPONSORS_2026.filter(s => s.tier === "networking").length, 3)}, minmax(200px, 280px))`,
          gap: 20,
          justifyContent: "center",
        }}>
          {CFK_SPONSORS_2026.filter(s => s.tier === "networking").map((sponsor, i) => (
            <motion.a
              key={sponsor.name}
              href={sponsor.url}
              target={sponsor.url && sponsor.url !== "#" ? "_blank" : undefined}
              rel={sponsor.url && sponsor.url !== "#" ? "noopener noreferrer" : undefined}
              aria-label={`${sponsor.name} — networking partner`}
              initial={{ opacity: 0, y: 36, scale: 0.96, filter: "blur(6px)" }}
              animate={inView ? { opacity: 1, y: 0, scale: 1, filter: "blur(0px)" } : {}}
            ...
            >
              ...
              <div className="cfk-sponsor-bezel" style={{
                ...
                {/* Recessed inner panel — white tile so the dark/purple logo reads */}
                <div style={{
                  position: "relative",
                  borderRadius: 19,
                  overflow: "hidden",
                  background: "linear-gradient(165deg, #ffffff 0%, #f2f3f7 100%)",
                  padding: "22px 26px",
                  minHeight: 180,
                  display: "flex",
                  alignItems: "center",
                  ...
                  {/* Logo — native colours on a white tile */}
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src={sponsor.logo}
                    alt={`${sponsor.name} logo`}
    ...
    <section ref={ref} id="reports" aria-hidden style={{ padding: 0, margin: 0, height: 0, overflow: "hidden" }}>
      ...
      {mounted && createPortal(
        <AnimatePresence>
          {modalOpen && (
            <motion.div
              className="cfk-req-modal-overlay"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              ...
              role="dialog"
              aria-modal="true"
              aria-labelledby="cfk-req-modal-title"
            >
              <motion.div
                className="cfk-req-modal-card"
              ...
              >
                ...
                <span aria-hidden className="cfk-req-modal-hairline" />

                <div className="cfk-req-modal-header">
                  ...
                  <h3 id="cfk-req-modal-title" style={{
                    margin: 0,
                    fontFamily: "var(--font-display)",
                ...
                {submitState === "success" ? (
                  <div className="cfk-req-modal-success">
                    <div className="cfk-req-modal-success-check">
                    ...
                    <button
                      type="button"
                      onClick={() => setModalOpen(false)}
                      className="cfk-req-modal-done"
                    >
                      Done
                    </button>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} noValidate className="cfk-req-form-fields">
                    {/* Honeypot */}
                    <input type="text" name="website" tabIndex={-1} autoComplete="off"
                      style={{ position: "absolute", left: "-9999px", opacity: 0, pointerEvents: "none" }} />

                    {/* Edition picker — used by both Delegate List and Past Event Report requests */}
                    <div className="cfk-req-form-row">
                      <label className="cfk-req-form-field" style={{ flex: "1 1 100%" }}>
                        <span className="cfk-req-form-label">Select Edition</span>
                        <select
                          ...
                          className="cfk-req-form-input cfk-req-form-report-select"
                        ...
                        {errors.report && <span className="cfk-req-form-err">{errors.report}</span>}
                      </label>
                    </div>

                    <div className="cfk-req-form-row">
                      <label className="cfk-req-form-field">
                        <span className="cfk-req-form-label">Full Name</span>
                        <input
                          type="text"
                          value={fullName}
                          ...
                          autoComplete="name"
                          className="cfk-req-form-input"
                          aria-invalid={!!errors.fullName}
                        />
                        {errors.fullName && <span className="cfk-req-form-err">{errors.fullName}</span>}
                      </label>

                      <label className="cfk-req-form-field">
                        <span className="cfk-req-form-label">Work Email</span>
                        <input
                          type="email"
                          value={email}
                        ...
                        />
                        {errors.email && <span className="cfk-req-form-err">{errors.email}</span>}
                      </label>
                    </div>

                    <div className="cfk-req-form-row">
                      <label className="cfk-req-form-field">
                        <span className="cfk-req-form-label">Job Title</span>
                        <input
                          type="text"
                          value={jobTitle}
                        ...
                        />
                        {errors.jobTitle && <span className="cfk-req-form-err">{errors.jobTitle}</span>}
                      </label>

                      <label className="cfk-req-form-field">
                        <span className="cfk-req-form-label">
                          Phone
                          <span className="cfk-req-form-hint-inline">
                            {countryCode.length} digits expected
                          </span>
                        </span>
                        <div className="cfk-req-form-phone-row">
                          <select
                          ...
                          <div className="cfk-req-form-phone-wrap">
                            <input
                              type="tel"
                              inputMode="numeric"
                              value={phone}
                              ...
                              className="cfk-req-form-input cfk-req-form-phone-input"
                              aria-invalid={!!errors.phone}
                            />
                            {phoneTouched && phoneIsValid && (
                              <span aria-hidden className="cfk-req-form-phone-check">
                        ...
                        {phoneTouched && !phoneIsValid && phoneDigitsLen > 0 && !errors.phone && (
                          <span className="cfk-req-form-phone-progress">
                            {phoneDigitsLen} / {countryCode.length} digits
                          </span>
                        )}
                        {errors.phone && <span className="cfk-req-form-err">{errors.phone}</span>}
                      </label>
                    </div>

                    {submitError && (
                      <div className="cfk-req-form-submit-err">{submitError}</div>
                    )}

                    <button
                      type="submit"
                      disabled={submitState === "submitting"}
                      className="cfk-req-form-submit"
                    >
      ...
      <style jsx global>{`
        ...
        .cfk-req-modal-card {
          ...
          background: linear-gradient(165deg, rgba(38, 18, 22, 0.94) 0%, rgba(16, 8, 10, 0.97) 100%);
        ...
        .cfk-req-modal-hairline {
          position: absolute;
          top: 0; left: 8%; right: 8%; height: 1px;
          background: linear-gradient(90deg, transparent 0%, ${C_BRIGHT} 30%, ${KENYA_ACCENT} 70%, transparent 100%);
          opacity: 0.8;
        }
        .cfk-req-modal-close {
          position: absolute;
        ...
        .cfk-req-modal-done:hover {
          transform: translateY(-1px);
          filter: brightness(1.08);
        }
        @media (max-width: 540px) {
          .cfk-req-modal-card { padding: 22px 18px; border-radius: 16px; }
          .cfk-req-modal-header { padding-right: 30px; }
        }
        ...
        .cfk-req-form-phone-wrap {
          position: relative;
          flex: 1;
        }
        .cfk-req-form-phone-check {
          position: absolute;
          right: 12px;
          top: 50%;
        ...
        .cfk-req-form-input::placeholder {
          color: rgba(255,255,255,0.30);
        }
        .cfk-req-form-input:focus {
          border-color: ${C_BRIGHT};
          background: rgba(0,0,0,0.40);
          box-shadow: 0 0 0 3px ${C}33;
        }
        .cfk-req-form-input[aria-invalid="true"] {
          border-color: rgba(255,80,80,0.6);
        }
        /* Edition picker — native select with a custom maroon chevron */
        .cfk-req-form-report-select {
          appearance: none;
          -webkit-appearance: none;
          -moz-appearance: none;
          padding-right: 40px;
          background-image: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='12' height='8' viewBox='0 0 12 8' fill='none'><path d='M1 1l5 5 5-5' stroke='%23B52230' stroke-width='1.6' stroke-linecap='round' stroke-linejoin='round'/></svg>");
          background-repeat: no-repeat;
          background-position: right 14px center;
          cursor: pointer;
        }
        .cfk-req-form-report-select option {
          background: #1a0e10;
          color: white;
        }
        .cfk-req-form-phone-row {
          display: flex;
          gap: 8px;
        }
        .cfk-req-form-cc {
        ...
        .cfk-req-form-cc:focus {
          border-color: ${C_BRIGHT};
          box-shadow: 0 0 0 3px ${C}33;
        }
        .cfk-req-form-cc option {
          background: #1a0e10;
          color: white;
        }
        .cfk-req-form-phone-input {
          flex: 1;
          width: 100%;
          padding-right: 40px;
        }
        ...
        .cfk-req-form-submit:hover:not(:disabled) {
          transform: translateY(-1px);
          filter: brightness(1.08);
          box-shadow: 0 12px 28px ${C}77, inset 0 1px 0 rgba(255,255,255,0.22);
        }
        .cfk-req-form-submit:disabled {
          opacity: 0.55;
          cursor: not-allowed;
        }
        .cfk-req-form-hint {
...
function Venue() {
  ...
  const venueDetails = [
    { icon: "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0zM12 13a3 3 0 100-6 3 3 0 000 6z", label: "Location", value: "Hyatt Regency, Nairobi" },
