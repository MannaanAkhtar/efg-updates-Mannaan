  ...
  return (
    <section ref={ref} style={{ position: "relative", padding: "clamp(40px, 4.5vw, 64px) 24px", background: "transparent", overflow: "hidden" }}>
            ...
            return (
              ...
              >
                {ready ? (
                  ...
                  <div className={`cfq-series-card cfq-series-card-soon${e.image ? " cfq-series-soon-photo" : ""}`} aria-label={`Cyber First ${e.city} — coming soon`}>
                    {e.image && (
                      <>
                        <span aria-hidden className="cfq-series-bg" style={{ backgroundImage: `url("${e.image}")` }} />
                        <span aria-hidden className="cfq-series-scrim" />
                      </>
                    )}
      ...
      <style jsx global>{`
        ...
        .cfq-series-card-soon > *:not(.cfq-series-bg):not(.cfq-series-scrim) { position: relative; z-index: 2; }
        .cfq-series-soon-photo, .cfq-series-soon-photo:hover { opacity: 1; }
        .cfq-series-soon-photo .cfq-series-bg { opacity: 0.55; }
        .cfq-series-soon-photo:hover .cfq-series-bg { opacity: 0.7; transform: scale(1.05); }
