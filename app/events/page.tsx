...
const allEvents = [
  ...
  },
  {
    ...
    tagline: "Customer Engagement & Trust",
    description: "A virtual roundtable exploring how brands build trust through personalised, context-aware engagement.",
    color: "#C9935A",
    image: "",
    href: "#",
    date: "2026-06-10",
  ...
  },
  {
    ...
    tagline: "Beyond the Hype: Redefining Growth with AI",
    description:
      "An invite-only evening for Riyadh's senior growth, marketing, product, and digital leaders — candid panels, curated breakouts, and high-trust exchange.",
    color: "#C9935A",
  ...
  {
    id: "crayon-ai-without-blindspots",
    category: "networkfirst",
    title: "Crayon × Microsoft Virtual Session",
    tagline: "AI Without Blindspots: Governing the Agentic Enterprise in MEA",
    description:
      "A virtual session hosted by Crayon and Microsoft on governing agentic AI deployments responsibly across MEA enterprises.",
    color: "#0078D4",
    image: "",
    href: "https://events.teams.microsoft.com/event/40a2a4b2-7568-4c65-b8cc-a312883c3171@1dc9b339-fadb-432e-86df-423c38a0fcb8#msdynmkt_trackingcontext=e4d52e22-099e-4a3b-aaf5-807974e20000",
    date: "2026-05-05",
    nextDate: "5 May 2026",
    nextCity: "Virtual",
    editions: "",
