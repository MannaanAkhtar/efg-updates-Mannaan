...
const allEvents = [
  ...
  },
  {
    ...
    description:
      "The inaugural Qatar edition of OT Security First, uniting CISOs, ICS engineers, and critical-infrastructure leaders to secure the physical core of the nation's energy, utilities, and industrial sectors.",
    color: "#D34B9A",
    image: "https://efg-final.s3.eu-north-1.amazonaws.com/events/OT+Security+First+UAE+2025/OT+First+UAE+Photos/4N8A0412.JPG",
    href: "/events/ot-security-first/qatar",
    date: "2026-11-18",
    nextDate: "3rd Week Nov 2026",
    nextCity: "Doha, Qatar",
    editions: "1st Edition Qatar",
    regions: "Qatar",
    attendees: "250+",
    status: "soon" as SeriesStatus,
  },
