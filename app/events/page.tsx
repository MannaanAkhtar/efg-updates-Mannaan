...
const allEvents = [
  ...
  {
    id: "networkfirst-oracle",
    category: "networkfirst",
    title: "Oracle AI: Powering the Intelligent Enterprise",
    tagline: "An exclusive executive experience",
    description:
      "Join Oracle for an exclusive executive experience exploring how AI is reshaping business and creating new opportunities for innovation, productivity, and growth.",
    color: "#C9935A",
    image: "",
    href: "/oracle",
    date: "2026-10-14",
