...
const allEvents = [
  ...
  },
  {
    ...
    tagline: "AlgoCity: Escape the Complexity",
    description:
      "An invitation-only executive roundtable where security leaders decode real-world application connectivity challenges, escape policy complexity, and explore how application context, automation and AI-assisted discovery accelerate secure application delivery.",
    color: "#C9935A",
    image: "",
    href: "/algosec",
    date: "2026-09-24",
  ...
  {
    id: "networkfirst-enterprisedb-southafrica",
    category: "networkfirst",
    title: "EnterpriseDB Executive Roundtable",
    tagline: "The Sovereign Data Estate",
    description:
    ...
    color: "#C9935A",
    image: "",
    href: "/enterprisedb-southafrica",
    date: "2026-11-12",
    nextDate: "12 Nov 2026",
    nextCity: "South Africa",
    editions: "",
  ...
  {
    id: "networkfirst-enterprisedb-uae",
    category: "networkfirst",
    title: "EnterpriseDB Executive Roundtable",
    tagline: "The Sovereign Data Estate",
    description:
    ...
    color: "#C9935A",
    image: "",
    href: "/enterprisedb-uae",
    date: "2026-11-25",
    nextDate: "25 Nov 2026",
    nextCity: "Dubai, UAE",
    editions: "",
    regions: "UAE",
    attendees: "15-20",
  ...
  {
    id: "networkfirst-proofpoint-sep23",
    category: "networkfirst",
  ...
  },
  {
    ...
    tagline: "Visibility, Control & Networked Execution",
    description:
      "An invitation-only Blue Yonder executive dinner on how GCC leaders orchestrate resilient, connected supply chain execution across suppliers, warehouses and transportation.",
    color: "#C9935A",
    image: "https://efg-final.s3.eu-north-1.amazonaws.com/logos/Blue_Yonder_rgb.png",
    href: "/blueyonder",
    date: "2026-09-23",
    nextDate: "23 Sep 2026",
  ...
  {
    id: "networkfirst-ifs-dubai",
    category: "networkfirst",
    title: "IFS Executive Briefing",
    tagline: "Responding to Supply Chain Disruption",
    description:
      "An IFS executive briefing on how logistics and supply chain leaders gain visibility, test scenarios, and act fast when volatility hits — in weeks, not months.",
    color: "#C9935A",
  ...
  },
  {
    ...
    tagline: "Cyber Resilience in the Age of Real-Time Threats",
    description:
      "An executive roundtable for cybersecurity leaders on modernising security beyond the firewall — cloud-managed perimeter security, Cloud Secure Edge, ZTNA, SASE, and managed security services (SOC, MDR, MXDR).",
    color: "#C9935A",
    image: "https://efg-final.s3.eu-north-1.amazonaws.com/boardroom/sonicwall_hero.png",
    href: "/sonicwall-7sept",
    date: "2026-09-07",
    nextDate: "7 Sep 2026",
    nextCity: "Saudi Arabia",
    editions: "",
  ...
  {
    id: "networkfirst-blackstone-liferay",
    category: "networkfirst",
    title: "Blackstone eIT × Liferay Roundtable",
    tagline: "AI-Powered Government: Enabling Citizen-Centered Experiences",
    description:
      "An invitation-only executive roundtable integrating Digital Experience Platforms with governed, scalable Agentic AI to empower Saudi Vision 2030. Co-hosted by Blackstone eIT and Liferay.",
    color: "#C9935A",
