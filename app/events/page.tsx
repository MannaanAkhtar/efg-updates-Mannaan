...
const allEvents = [
  ...
  {
    id: "networkfirst-filigran",
    category: "networkfirst",
    title: "Filigran Executive Roundtable",
    tagline: "Agentic CTEM in Practice — Supercharge your CTI & Exposure Validation with AI Agents",
    description: "An online executive roundtable with Filigran — uniting threat intelligence (CTI) and adversarial exposure validation (AEV) with AI agents.",
    color: "#C9935A",
    image: "https://efg-final.s3.eu-north-1.amazonaws.com/sponsors-logo/LOGO_FILIGRAN_BLANC.png",
    href: "/filigran",
    date: "2026-07-07",
    nextDate: "7 July 2026",
    nextCity: "Online",
    editions: "",
    regions: "Online",
    attendees: "15-20",
