...
const events: Array<{ name: string; path: string; series: string }> = [
  ...
  { name: "Cyber First India 2026", path: "/events/cyber-first/india-2026", series: "Cyber First" },
  ...
  { name: "Cyber First Oman 2026", path: "/events/cyber-first/oman-2026", series: "Cyber First" },
  { name: "Cyber First KSA 2026", path: "/events/cyber-first/ksa-2026", series: "Cyber First" },
  ...
  { name: "OT Security First Jubail 2026", path: "/events/ot-security-first/jubail-2026", series: "OT Security First" },
  ...
  { name: "Digital First Kuwait 2026", path: "/events/data-ai-first/kuwait-2026", series: "Digital First" },
  { name: "Digital First Qatar 2026", path: "/events/data-ai-first/qatar-2026", series: "Digital First" },
