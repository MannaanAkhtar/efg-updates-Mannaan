...
const SPEAKERS: Speaker[] = [
  ...
  { name: "Naif Alshahrani", title: "Cybersecurity GRC Director", org: "Confidential", photo: "https://efg-final.s3.eu-north-1.amazonaws.com/Speakers-photos/Naif+Alshahrani.jpeg", linkedin: "https://www.linkedin.com/in/naif-alshahrani-950646110", flag: "https://flagcdn.com/w40/sa.png" },
  { name: "Eng. Ali Altamni", title: "Senior Cybersecurity Leader", org: "SABIC", photo: "https://efg-final.s3.eu-north-1.amazonaws.com/Speakers-photos/Eng.Ali+Altamni.png", linkedin: "https://www.linkedin.com/in/eng-atm-g3altamni/", flag: "https://flagcdn.com/w40/sa.png" },
  ...
  { name: "Yazed Alamam", title: "Associate Director – Subsidiary and OT Cybersecurity", org: "Red Sea Global", photo: "https://efg-final.s3.eu-north-1.amazonaws.com/Speakers-photos/Yazed+Alamam.png", linkedin: "https://www.linkedin.com/in/yazeedti/", flag: "https://flagcdn.com/w40/sa.png" },
  ...
  { name: "Mohammed Alangari", title: "CISO & VP of GRC", org: "Confidential Government Authority", photo: "https://efg-final.s3.eu-north-1.amazonaws.com/Mohammed+Alangari.jpeg", linkedin: "https://www.linkedin.com/in/mohammed-aalangari/", flag: "https://flagcdn.com/w40/sa.png" },
...
type JbEdition = { city: string; edition: string; when: string; href?: string; logo?: string; image?: string; scrimLight?: boolean };
const JB_EDITIONS: JbEdition[] = [
  { city: "Doha, Qatar", edition: "Qatar Edition", when: "November 2026", href: "/events/ot-security-first/qatar", logo: "https://efg-final.s3.eu-north-1.amazonaws.com/assets/OT+Qatar-02.png", image: "https://efg-final.s3.eu-north-1.amazonaws.com/assets/OT_qatar.png", scrimLight: true },
...
function SeriesEditions() {
  ...
  return (
    <section ref={ref} style={{ position: "relative", padding: "clamp(40px, 4.5vw, 64px) 24px", background: BG_BASE, overflow: "hidden" }}>
      <div style={{ position: "relative", zIndex: 1, maxWidth: 1120, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 16 }}>
          <span style={{ fontFamily: "var(--font-outfit)", fontSize: 11, fontWeight: 700, color: CYAN, textTransform: "uppercase", letterSpacing: "4.5px" }}>OT Security First Series</span>
        </div>
        <motion.h2
        ...
        <div className="jb-series-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }}>
          {JB_EDITIONS.map((e, i) => {
            ...
            return (
              ...
              >
                {ready ? (
                  <Link href={e.href!} className="jb-series-card jb-series-card-live" aria-label={`OT Security First ${e.city} — ${e.edition}, ${e.when}`}>
                    <span aria-hidden className="jb-series-bg" style={{ backgroundImage: `url("${e.image}")` }} />
                    <span aria-hidden className={`jb-series-scrim${e.scrimLight ? " jb-series-scrim-light" : ""}`} />
                    <span className="jb-series-logo-wrap">
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img src={e.logo} alt={`OT Security First ${e.city}`} loading="lazy" className="jb-series-logo" />
                    </span>
                    ...
                    <span className="jb-series-go" style={{ marginTop: 6, display: "inline-flex", alignItems: "center", gap: 7, fontFamily: "var(--font-outfit)", fontSize: 11, fontWeight: 600, letterSpacing: "1.4px", textTransform: "uppercase", color: "rgba(255,255,255,0.6)" }}>
                      View event
                  ...
                  <div className="jb-series-card jb-series-card-soon" aria-label={`OT Security First ${e.city} — coming soon`}>
                    <span className="jb-series-soon-top">
                      <span className="jb-series-soon-badge">
                        <span aria-hidden className="jb-series-soon-dot" />
                        Coming Soon
                      </span>
                    </span>
      ...
      <style jsx global>{`
        .jb-series-card { position: relative; overflow: hidden; display: flex; flex-direction: column; gap: 6px; height: 100%; padding: 22px 20px; border-radius: 16px; text-decoration: none; border: 1px solid rgba(255,255,255,0.1); background: linear-gradient(160deg, rgba(255,255,255,0.05), rgba(255,255,255,0.014)); box-shadow: inset 0 1px 0 rgba(255,255,255,0.07); transition: transform 0.4s cubic-bezier(0.22,1,0.36,1), border-color 0.4s ease, box-shadow 0.4s ease; }
        .jb-series-card:hover { transform: translateY(-5px); border-color: ${C}66; box-shadow: inset 0 1px 0 rgba(255,255,255,0.12), 0 18px 40px rgba(0,0,0,0.45), 0 0 34px ${C}22; }
        .jb-series-card:hover .jb-series-go { color: ${CYAN}; }
        .jb-series-card-live > *:not(.jb-series-bg):not(.jb-series-scrim) { position: relative; z-index: 2; }
        .jb-series-bg { position: absolute; inset: 0; z-index: 0; background-size: cover; background-position: center; opacity: 0.5; transform: scale(1.02); transition: opacity 0.5s ease, transform 0.6s cubic-bezier(0.22,1,0.36,1); }
        .jb-series-scrim { position: absolute; inset: 0; z-index: 1; background: linear-gradient(180deg, rgba(5,8,24,0.62) 0%, rgba(5,8,24,0.82) 58%, rgba(5,8,24,0.95) 100%); }
        .jb-series-scrim-light { background: linear-gradient(180deg, rgba(5,8,24,0.38) 0%, rgba(5,8,24,0.62) 58%, rgba(5,8,24,0.86) 100%); }
        .jb-series-card-live:hover .jb-series-bg { opacity: 0.68; transform: scale(1.06); }
        .jb-series-logo-wrap { display: flex; align-items: center; justify-content: flex-start; height: 52px; margin-bottom: 8px; }
        .jb-series-logo { max-height: 52px; max-width: 100%; width: auto; object-fit: contain; filter: drop-shadow(0 4px 12px rgba(0,0,0,0.4)); }
        .jb-series-card-soon { cursor: default; opacity: 0.72; }
        .jb-series-card-soon:hover { transform: none; border-color: ${C}33; box-shadow: inset 0 1px 0 rgba(255,255,255,0.07), 0 0 26px ${C}18; opacity: 0.85; }
        .jb-series-soon-top { display: flex; align-items: center; height: 52px; margin-bottom: 8px; }
        .jb-series-soon-badge { display: inline-flex; align-items: center; gap: 7px; padding: 7px 13px; border-radius: 999px; border: 1px solid ${CYAN}40; background: ${CYAN}14; font-family: var(--font-outfit); font-size: 10px; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; color: ${CYAN}; }
        .jb-series-soon-dot { width: 6px; height: 6px; border-radius: 50%; background: ${CYAN}; box-shadow: 0 0 8px ${CYAN}; animation: jbSeriesSoonPulse 1.8s ease-in-out infinite; }
        @keyframes jbSeriesSoonPulse { 0%,100% { opacity: 1; transform: scale(1); } 50% { opacity: 0.4; transform: scale(1.4); } }
        @media (max-width: 900px) { .jb-series-grid { grid-template-columns: repeat(2, 1fr) !important; } }
        @media (max-width: 520px) { .jb-series-grid { grid-template-columns: 1fr !important; } }
      `}</style>
    </section>
  );
}
    ...
    rows: [
      {
        ...
        panelists: [
          ...
          { name: "Dr. Hussain Aldawood", role: "Director of Cybersecurity Consulting", org: "EY" },
          { name: "Ahmed Al Saleh", role: "Head of Digital & OT Cybersecurity Initiatives", org: "Aramco", moderator: true },
        ],
      },
      {
        time: "11:00 – 11:15",
...
// ───────────────────────────────────────────────────────────────────────────
function OTSfJbPostReportFloat() {
  const [mounted, setMounted] = useState(false);
  ...
  const DISMISS_KEY = "otsf-jb-report-dismissed";
  const NUDGE_KEY = "otsf-jb-report-nudged";
  ...
  const handleOpen = () => {
    window.dispatchEvent(new CustomEvent("otsf-jb:open-request", { detail: { type: "Past Event Report" } }));
    setShowNudge(false);
  };
    ...
    <>
      <AnimatePresence>
        {showStickyNote && (
          ...
          >
            <button
              type="button"
              className="otsf-jb-report-note-close"
            ...
            <span aria-hidden className="otsf-jb-report-note-hairline" />

            <div className="otsf-jb-report-note-icon">
            ...
            <div className="otsf-jb-report-note-body">
              <span className="otsf-jb-report-note-eyebrow">
                <span className="otsf-jb-report-note-pulse" aria-hidden />
                Free Download
              </span>
              <span className="otsf-jb-report-note-title">
                Download our Post Event Reports
              </span>
              <span className="otsf-jb-report-note-cta">
                View past editions
      ...
      <AnimatePresence>
        {showIcon && (
          <motion.div
            ...
            className="otsf-jb-report-fab-wrap"
          ...
          >
            <AnimatePresence>
              {showNudge && (
                <motion.div
                  key="nudge"
                  className="otsf-jb-report-fab-nudge"
                ...
                >
                  <span className="otsf-jb-report-fab-nudge-eyebrow">
                    <span className="otsf-jb-report-note-pulse" aria-hidden /> Free Download
                  </span>
                  <span className="otsf-jb-report-fab-nudge-text">
                    Download our Post Event Reports
                  </span>
                  <button
                    type="button"
                    className="otsf-jb-report-fab-nudge-close"
                  ...
                  <span aria-hidden className="otsf-jb-report-fab-nudge-tail" />
                </motion.div>
              )}
            </AnimatePresence>

            <div className="otsf-jb-report-fab-btnwrap">
              <button
                type="button"
                className="otsf-jb-report-fab"
                onClick={handleOpen}
                aria-label="Download Post Event Reports"
                title="Download Post Event Reports"
              >
                <span aria-hidden className="otsf-jb-report-fab-pulse" />
              ...
              <button
                type="button"
                className="otsf-jb-report-fab-close"
                onClick={handleDismiss}
                aria-label="Dismiss"
              >
      ...
      <style jsx global>{`
        ...
        .otsf-jb-report-note {
          ...
          border-radius: 999px;
          cursor: pointer;
          background: linear-gradient(145deg, ${BG_BASE} 0%, ${BG_DEEP} 100%);
        ...
        .otsf-jb-report-note-close:hover {
          color: white;
          background: ${C};
          border-color: ${C_BRIGHT};
          transform: rotate(90deg) scale(1.08);
        }
        .otsf-jb-report-note-icon {
          flex-shrink: 0;
        ...
        .otsf-jb-report-note-pulse {
          width: 6px; height: 6px; border-radius: 50%;
          background: ${C_BRIGHT};
          box-shadow: 0 0 8px ${C};
          animation: otsfJbReportPulse 1.6s ease-in-out infinite;
        }
        .otsf-jb-report-note-title {
        ...
        .otsf-jb-report-note:hover .otsf-jb-report-note-cta { color: ${C_BRIGHT}; }
        @keyframes otsfJbReportPulse {
          0%, 100% { opacity: 1; transform: scale(1); }
          50%      { opacity: 0.45; transform: scale(1.5); }
        }

        /* ── FAB icon (State B) ────────────────────────────────────────── */
        .otsf-jb-report-fab-wrap {
          position: fixed;
          bottom: 96px;
          right: 24px;
          z-index: 50;
        ...
        .otsf-jb-report-fab-pulse {
          position: absolute;
          inset: 0;
          border-radius: 50%;
          background: ${C};
          opacity: 0.4;
          animation: otsfJbFabRing 2.4s ease-out infinite;
          z-index: -1;
        }
        @keyframes otsfJbFabRing {
          0%   { transform: scale(1);   opacity: 0.55; }
          80%  { transform: scale(1.7); opacity: 0;    }
          100% { transform: scale(1.7); opacity: 0;    }
        }
        .otsf-jb-report-fab-close {
          position: absolute;
          top: -6px; right: -6px;
        ...
        .otsf-jb-report-fab-close:hover {
          color: white;
          background: ${C};
          border-color: ${C_BRIGHT};
          transform: rotate(90deg) scale(1.08);
        ...
        .otsf-jb-report-fab-nudge-eyebrow {
          font-family: var(--font-outfit);
          font-size: 8.5px;
          font-weight: 700;
        ...
        .otsf-jb-report-fab-nudge-close {
          position: absolute;
          top: 6px; right: 6px;
          width: 20px; height: 20px;
          display: flex; align-items: center; justify-content: center;
        ...
        .otsf-jb-report-fab-nudge-close:hover {
          color: white;
          background: ${CYAN}33;
          border-color: ${CYAN}88;
        }
        .otsf-jb-report-fab-nudge-tail {
          position: absolute;
          right: -6px; top: 50%;
        ...
        @media (max-width: 700px) {
          .otsf-jb-report-fab-wrap { bottom: 88px; right: 16px; }
          .otsf-jb-report-fab { width: 50px; height: 50px; }
          .otsf-jb-report-fab-nudge { max-width: 200px; padding: 10px 28px 10px 12px; }
        }
      `}</style>
    </>
  );
