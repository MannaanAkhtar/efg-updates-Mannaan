...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:
      "The Next Chapter in Human and Agentic Security — Proofpoint Executive Roundtable",
    description:
      "Invitation-only Proofpoint roundtable for senior security leaders on agentic-era risk and human-centric defence. 23 June 2026, Riyadh.",
    url: PAGE_URL,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Proofpoint Executive Roundtable — Riyadh, 23 June 2026",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    description: "Invitation-only roundtable. 23 June 2026, Riyadh.",
    images: [OG_IMAGE],
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            startDate: "2026-06-23T10:30:00+03:00",
