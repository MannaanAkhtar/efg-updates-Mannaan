...
export const metadata: Metadata = {
  title: "The Sovereign Data Estate | EDB Executive Roundtable, Egypt — 13 Oct 2026",
  description:
    "An invite-only executive roundtable on building a sovereign data estate on open-source Postgres — reducing cost, meeting data-sovereignty mandates, and scaling with AI. 13 October 2026, Egypt. Hosted with EDB.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Breaking free from proprietary lock-in: a closed-door roundtable for senior IT & data leaders on building a sovereign data estate with Postgres. 13 October 2026.",
    url: PAGE_URL,
  ...
  twitter: {
    ...
    title: "The Sovereign Data Estate — EDB Executive Roundtable, Egypt",
    description:
      "A closed-door roundtable for senior IT & data leaders on building a sovereign data estate with Postgres. 13 October 2026, Egypt.",
    images: [OG_IMAGE],
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            startDate: "2026-10-13T09:00:00+02:00",
            endDate: "2026-10-13T12:00:00+02:00",
