...
const PAGE_URL = `${BASE_URL}/enterprisedb-ksa`;
const OG_IMAGE = "https://efg-final.s3.eu-north-1.amazonaws.com/sponsors-logo/edb_postgres_ai_lightmode%402x+(4).png";

export const metadata: Metadata = {
  title: "The Sovereign Data Estate | EDB Executive Roundtable, Saudi Arabia — 29 Sep 2026",
  description:
    "An invite-only executive roundtable on building a sovereign data estate on open-source Postgres — reducing cost, meeting data-sovereignty mandates, and scaling with AI. 29 September 2026, Saudi Arabia. Hosted with EDB.",
  keywords: [
    ...
    "executive roundtable Saudi Arabia",
    "CIO CTO roundtable KSA",
  ...
  openGraph: {
    title: "The Sovereign Data Estate — EDB Executive Roundtable, Saudi Arabia",
    description:
      "Breaking free from proprietary lock-in: a closed-door roundtable for senior IT & data leaders on building a sovereign data estate with Postgres. 29 September 2026.",
    url: PAGE_URL,
  ...
  twitter: {
    ...
    title: "The Sovereign Data Estate — EDB Executive Roundtable, Saudi Arabia",
    description:
      "A closed-door roundtable for senior IT & data leaders on building a sovereign data estate with Postgres. 29 September 2026, Saudi Arabia.",
    images: [OG_IMAGE],
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            startDate: "2026-09-29T09:00:00+03:00",
            endDate: "2026-09-29T12:00:00+03:00",
