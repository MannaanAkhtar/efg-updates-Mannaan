...
export function getSourceCategory(): string {
  ...
  if (p.startsWith("/blackstone-liferay")) return "Blackstone eIT × Liferay Executive Roundtable — AI-Powered Government (20 Oct 2026)";
  if (p.startsWith("/sonicwall-7sept")) return "SonicWall Executive Roundtable — Cyber Resilience (7 Sep 2026)";
